...
//    
//    NSLayoutConstraint *imageHeight = [NSLayoutConstraint constraintWithItem:imagePanel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self attribute:NSLayoutAttributeHeight multiplier:0.6 constant:1];
...
//    NSLayoutConstraint *buttonsHeight = [NSLayoutConstraint constraintWithItem:self attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:buttonsPanel attribute:NSLayoutAttributeHeight multiplier:0.4 constant:1];
