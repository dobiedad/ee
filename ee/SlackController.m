...
- (void)viewDidLoad
{
    ...
    [self.tableView registerClass:[SlackTableViewCell class] forCellReuseIdentifier:MessengerCellIdentifier];
    ...
    [self.autoCompletionView registerClass:[SlackTableViewCell class] forCellReuseIdentifier:AutoCompletionCellIdentifier];
...
{
    SlackTableViewCell *cell = (SlackTableViewCell *)gesture.view;
...
- (SlackTableViewCell *)messageCellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    SlackTableViewCell *cell = (SlackTableViewCell *)[self.tableView dequeueReusableCellWithIdentifier:MessengerCellIdentifier];
...
- (SlackTableViewCell *)autoCompletionCellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    SlackTableViewCell *cell = (SlackTableViewCell *)[self.autoCompletionView dequeueReusableCellWithIdentifier:AutoCompletionCellIdentifier];
    cell.indexPath = indexPath;
